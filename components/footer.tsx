export default function Footer({ font }: any) {
  return (
    <div className="w-full flex flex-col justify-center items-center bg-black text-white p-8 pb-6">
      <div className="flex-col lg:flex lg:flex-row lg:justify-between lg:w-full">
        <div className="m-3 text-center">
          <h1 className={`${font.className} text-4xl uppercase`}>Youverse</h1>
          <ul className="flex mt-5 mb-7 justify-center">
            <li className="mr-5">
              <svg
